...
class AssignStoreController extends Controller
{
    public function __construct(
        private AssignStore $assign_store,
    ){}
    ...
    public function add_new(): View|Factory|Application
    {
        ...
        return view('admin-views.assign-store.add-new', compact('rls'));
    }
    ...
    function list(Request $request): View|Factory|Application
    {
        ...
        return view('admin-views.assign-store.list', compact('em','search'));
    }
    ...
    public function edit($id): View|Factory|Application
    {
        ...
        $rls = $this->admin_role->whereNotIn('id', [1])->get();
        return view('admin-views.assign-store.edit', compact('rls', 'e'));
    }
