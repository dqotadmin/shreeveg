...
class WarehouseController extends Controller
{
    ...
    public function wh_assign_category_page($id): View|Factory|Application
    {
        ...
        $warehouses = $this->warehouse->withoutGlobalScopes()->with('translations')->find($id);
        return view('admin-views.warehouse.assign_categories', compact('warehouses','categories','wh_assign_categories'));
    }
    ...
    {
        $status = $this->warehouse_categories->find($request->id);
