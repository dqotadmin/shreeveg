                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-0">
                                    <label class="input-label" for="exampleFormControlSelect1">{{translate('item')}} {{translate('type')}}<span class="input-label-secondary">*</span></label>
                                    <select name="item_type" class="form-control" onchange="show_item(this.value)">
                                        <option value="home_page">{{translate('Home Page')}}</option>
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group mb-0" id="type-category" style="display: none">
                                    <label class="input-label" for="exampleFormControlSelect1">{{translate('category')}} <span class="input-label-secondary">*</span></label>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex flex-column justify-content-center h-100">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="url" name="video_url" value="{{old('title')}}" class="form-control"  placeholder="https://example.com" maxlength="255">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card--header justify-content-between max--sm-grow">
                ...
                <form action="{{url()->current()}}" method="GET">
                    <div class="input-group">
                        <input type="search" name="search" class="form-control" placeholder="{{translate('Search_by_ID_or_name')}}" aria-label="Search" value="{{$search}}" required autocomplete="off">
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="toggle-switch my-0">
                                <input type="checkbox" onclick="status_change_alert('{{ route('admin.banner.status', [$banner->id, $banner->status ? 0 : 1]) }}', '{{ $banner->status? translate('you_want_to_disable_this_banner'): translate('you_want_to_active_this_banner') }}', event)" class="toggle-switch-input" id="stocksCheckbox{{ $banner->id }}" {{ $banner->status ? 'checked' : '' }}>
                        ...
                        <td>
                            ...
                            <div class="btn--container justify-content-center">
                                <a class="action-btn" href="{{route('admin.banner.edit',[$banner['id']])}}">
                                    <i class="tio-edit"></i></a>
                                <a class="action-btn btn--danger btn-outline-danger" href="javascript:" onclick="form_alert('banner-{{$banner['id']}}','{{ translate("Want to delete this") }}')">
