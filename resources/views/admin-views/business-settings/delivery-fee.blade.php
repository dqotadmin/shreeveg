                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 pt-5">
                                ...
                                <div class="form-group">
                                    <label
                                        ...
                                        <input type="checkbox" class="toggle-switch-input" name="free_delivery_status"
                                            {{ $free_delivery_status == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-12 mt-4">
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        <div>
                                            <label>{{translate('minimum_shipping_charge')}}
                                                <span>({{ \App\CentralLogics\Helpers::currency_symbol() }})</span></label><br>
                                            <input type="number" step=".01" class="form-control"
                                                name="min_shipping_charge" value="{{$config['min_shipping_charge']}}"
                                                id="min_shipping_charge" {{ $config['status']==0?'disabled':'' }}>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div>
                                            <label>{{translate('shipping_charge_per_km')}}
                                                <span>({{ \App\CentralLogics\Helpers::currency_symbol() }})</span></label><br>
                                            <input type="number" step=".01" class="form-control" name="shipping_per_km"
                                                value="{{$config['shipping_per_km']}}" id="shipping_per_km"
                                                {{ $config['status']==0?'disabled':'' }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-12 mt-4">
                                ...
                                <label class="" for="exampleFormControlInput1">{{translate('default_delivery_charge')}}
