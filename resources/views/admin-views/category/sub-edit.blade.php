                    ...
                    <div class="row">
                                ...
                                @foreach($data as $lang)
                                    <div class="col-sm-6 {{$lang['default'] == false ? 'd-none':''}} lang_form" id="{{$lang['code']}}-form">
                                        ...
                                        class="form-control" maxlength="255" placeholder="{{ translate('New Sub Category') }}" {{$lang['status'] == true ? 'required':''}}
                                ...
                                @foreach($data as $lang)
                                    <div class="col-sm-6 {{$lang['default'] == false ? 'd-none':''}} lang_form" id="{{$lang['code']}}-form">
                                        ...
                                        class="form-control" maxlength="255" placeholder="{{ translate('title_silver') }}" {{$lang['status'] == true ? 'required':''}}
                                        @if($lang['status'] == true) oninvalid="document.getElementById('{{$lang['code']}}-link').click()" @endif>
                                    </div>
                                    <input type="hidden" name="lang[]" value="{{$lang['code']}}">
                                @endforeach
                                ...
                                @foreach($data as $lang)
                                    <div class="col-sm-6 {{$lang['default'] == false ? 'd-none':''}} lang_form" id="{{$lang['code']}}-form">
                                        ...
                                        class="form-control" maxlength="255" placeholder="{{ translate('item_code') }}" {{$lang['status'] == true ? 'required':''}}
                                        @if($lang['status'] == true) oninvalid="document.getElementById('{{$lang['code']}}-link').click()" @endif>
                                    </div>
                                    <input type="hidden" name="lang[]" value="{{$lang['code']}}">
                                @endforeach
                                @foreach($data as $lang)
                                    <div class="col-sm-6 {{$lang['default'] == false ? 'd-none':''}} lang_form" id="{{$lang['code']}}-form">
                                        ...
                                        class="form-control" maxlength="255" placeholder="{{ translate('title_gold') }}" {{$lang['status'] == true ? 'required':''}}
                                        @if($lang['status'] == true) oninvalid="document.getElementById('{{$lang['code']}}-link').click()" @endif>
                                    </div>
                                    <input type="hidden" name="lang[]" value="{{$lang['code']}}">
                                @endforeach
                                ...
                                @foreach($data as $lang)
                                    <div class="col-sm-6 {{$lang['default'] == false ? 'd-none':''}} lang_form" id="{{$lang['code']}}-form">
                                        ...
                                        class="form-control" maxlength="255" placeholder="{{ translate('title_platinum') }}" {{$lang['status'] == true ? 'required':''}}
                                        @if($lang['status'] == true) oninvalid="document.getElementById('{{$lang['code']}}-link').click()" @endif>
                                    </div>
                                    <input type="hidden" name="lang[]" value="{{$lang['code']}}">
                                @endforeach
                                ...
                                @foreach($data as $lang)
                                    <div class="col-sm-6 {{$lang['default'] == false ? 'd-none':''}} lang_form" id="{{$lang['code']}}-form">
                                        ...
                                        class="form-control" maxlength="255" placeholder="{{ translate('unit_title') }}" {{$lang['status'] == true ? 'required':''}}
                                        @if($lang['status'] == true) oninvalid="document.getElementById('{{$lang['code']}}-link').click()" @endif>
                                    </div>
                                    <input type="hidden" name="lang[]" value="{{$lang['code']}}">
                                @endforeach
                                ...
                                <div class="col-sm-6 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="exampleFormControlSelectsub_unit_title" name="sub_unit_title[]" class="form-control" required>
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group">
                                        <label class="form-label"
                                            for="exampleFormControlSelectmain_category">{{translate('main')}} {{translate('category')}}
                                            <span class="input-label-secondary">*</span></label>
                                        <select id="exampleFormControlSelectmain_category" name="parent_id" class="form-control" required>
                                            @foreach(\App\Model\Category::where(['position'=>0])->get() as $cat)
                                                <option
                                                    value="{{$cat['id']}}" {{$category['parent_id']==$cat['id']?'selected':''}}>
                                                    {{$cat['name']}}
                                                </option> 
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label"
                                            for="exampleFormControlSelect1">{{translate('Unit')}}
                                            <span class="input-label-secondary">*</span></label>
                                        <select id="exampleFormControlSelect1" name="unit[]" class="form-control chosen-select" multiple required>
                                    @if($category['unit'])
                                            @foreach(\App\Model\Unit::get() as $unit)
                                                <option
                                                    value="{{$unit['id']}}" {{in_array($unit->id,json_decode($category['unit'],true))?'selected':''}}>{{$unit['title']}}
                                                </option>
                                            @endforeach
                                    @else
