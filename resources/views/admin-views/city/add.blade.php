                        ...
                        <form action="{{route('admin.city.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row align-items-end g-4" style="padding-top: 50px;">
                                      <div class="col-sm-6">
                                            ...
                                            <input type="text" name="city" class="form-control" placeholder="{{ translate('Ex: Jaipur') }}" maxlength="255" >
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="form-label"  for="">{{ translate('City') }} {{ translate('Code') }} 
                                            </label>
                                            <input type="text" name="city_code" class="form-control" placeholder="{{ translate('Ex: 0141') }}" maxlength="255" >
                                        </div>
                                        <div class="col-sm-6" >
