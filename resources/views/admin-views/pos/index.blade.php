                ...
                <div class="card">
                    <div class="card-header m-1 bg-light border-0">
                        ...
                        @if (count($adminOffers) > 0)
                            ...
                            <button class="btn btn-sm" type="button" data-toggle="modal" data-target="#available_offers"><i
                                    class="tio-edit"></i> Available Offers
                            </button>
                            <div class="product_model">
                                <div class="modal fade " id="available_offers" tabindex="-1">
                                                    ...
                                                    <table
                                                        ...
                                                        <thead class="thead-light">
                                                            <tr>
                                                                ...
                                                                <th class="border-0">{{ translate('products') }}</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @foreach ($adminOffers as $key => $flash_deal)
                                                                <tr>
                                                                    <td>{{ $key + 1 }}</td>
                                                                    <td>
                                                                        <span
                                                                            class="d-block font-size-sm text-body text-trim-25">
                                                                    ...
                                                                    <td>{{ date('d-M-y', strtotime($flash_deal['start_date'])) }}
                                                                        -
                                                                        {{ date('d-M-y', strtotime($flash_deal['end_date'])) }}
                                                                        <br>
                                                                    ...
                                                                    <td class="text-center">
                                                                        {{ count($flash_deal->products) }}
                                                                        <a data-toggle="collapse"
                                                                            href="#productcolabse_{{ $flash_deal['id'] }}"
                                                                            role="button" aria-expanded="false"
                                                                            aria-controls="productcolabse">
                                                                        ...
                                                                        <div class="collapse"
                                                                            id="productcolabse_{{ $flash_deal['id'] }}">
                                                                            <div class="product_list">
                                                                                @if ($flash_deal->offer_type === 'other')
                                                                                    <div class="row product_tabke_mainmn">


                                                                                        @foreach ($flash_deal->products as $opKey => $offProduct2)
                                                                                            <div class="col-md-4">
                                                                                                @if ($opKey == 0)
                                                                                                    <div class="heading">
                                                                                                        Product
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                ...
                                                                                                @endif
                                                                                                <div class="item">
                                                                                                    {{ $offProduct2['quantity'] }}
                                                                                                    {{ @$offProduct2->product->unit->title }}
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-4">
                                                                                                @if ($opKey == 0)
                                                                                ...
                                                                                @else
                                                                                    <?php $offerProducts = [];
                                                                                    foreach ($flash_deal->products as $offProduct) {
                                                                                        array_push($offerProducts, @$offProduct->product->name);
                                                                                    }
                                                                                    ?>
                                                                                    {{ implode(', ', $offerProducts) }}
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                                        <br>
                        ...
                        <div class="px-4">
                            ...
                            <div class="w-100 py-2">
                                ...
                                <select onchange="store_key('branch_id',this.value)" id='branch' name="branch_id"
                                    ...
                                    <option value="{{ @$authUser->Store->id }}" selected>{{ @$authUser->Store->name }}
                                    </option>
