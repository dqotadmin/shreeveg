                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="unit_id" id="" class="js-select2-custom required-select custom-select" required>
...
<!-- 
                            <div class="col-sm-6">
                                ...
                                <label class="input-label" for="exampleFormControlInput1">GST rate <span id="tax_symbol">(%)</span></label>
