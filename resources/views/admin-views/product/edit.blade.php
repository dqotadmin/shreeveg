    ...
    <form action="javascript:" method="post" id="product_form" enctype="multipart/form-data" class="row g-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01" value="{{$product['total_stock']}}"
                                    name="total_stock" class="form-control" placeholder="{{ translate('Ex : 54') }}"
                                    required>
                            </div>
                        </div>
                        <!-- <div class="col-sm-6">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-1">
                                <div class="form-group mb-0">
                                    ...
                                    <input type="number" min="0" max="10000000000" step="any"
                                        value="{{$product_data['quantity']}}" name="quantity[]" class="form-control"
                            ...
                            <div class="col-sm-2">
                                ...
                                <select name="unit_id[]" id="" class="form-control js-select2-custom">
                                    ...
                                    <option value="{{$unit->id}}"
                                        {{$product_data['unit_id'] == $unit->id ? 'selected': ''}}
                                        style="text-transform: capitalize;">{{$unit->title}}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                            <div class="col-sm-2">
                                ...
                                <input name="offer_price[]" min="0" max="100000000" step="any"
                                    value="{{$product_data['offer_price']}}" class="form-control"
                                    placeholder="{{ translate('Ex : 10') }}" required>
                            </div>
                            <div class="col-sm-2">
                                <label class="input-label"
                                    for="exampleFormControlInput1">{{translate('Actual Price')}}</label>
                                <input name="actual_price[]" min="0" max="100000000" step="any"
                                    value="{{$product_data['actual_price']}}" class="form-control"
                            ...
                            <div class="col-sm-2">
                                ...
                                <input name="approx_piece[]" min="0" max="100000000" step="any" class="form-control"
                                    value="{{$product_data['approx_piece']}}"
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" min="0" max="100000000" step="any" name="title[]"
                                    class="form-control" value="{{$product_data['title']}}"
        ...
        <div class="col-12">
            <div class="btn--container justify-content-end">
                <a type="button" href="{{route('admin.product.list')}}" class="btn btn--reset">{{translate('back')}}</a>
