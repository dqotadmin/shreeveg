...
<div class="content container-fluid">
    <!-- Page Header -->
    <div class="page-header"><?php $currentDate = date('d-M-y', strtotime('today')); ?>
                    ...
                    <tr class="">
                     ...
                     ?>
                        ...
                        @if($price)  
                            ...
                            <input type="number"  class="form-control w-50 avg_price" value="" name="margin[]" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');">  
